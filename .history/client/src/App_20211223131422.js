            ...
            taskList.map(val => (
              <div key={val.id} className='taskCard'>
                ...
                <div className='taskCardUpdate'>
                  ...
                  <button onClick={() => {updateTaskList(val.id }} disabled={(val.status) === 'incomplete' ? false : true}>
                    Update
                  </button>
                </div>
                <div className='taskCardButton'>
                  <button
                    onClick={() => { updateStatus(val.id) }} disabled={(val.status) === 'incomplete' ? false : true}
                  className='taskCardComplete'>
                    Completed!
                  </button>
